    ...
    <div className="bots-container">
      <div className="bots-content container mx-auto">
        <header className="header">
          <h1 className="title">Market Maker Bot</h1>
          <p className="subtitle">Automate liquidity and swaps for your DEX</p>
          {isPaid && startDate && (
            <p className="status-text">Active: {daysElapsed} / 30 days</p>
          )}
        </header>
        {loading ? (
          ...
          <div className="no-wallet-card">
            <p className="no-wallet-text">Connect your wallet to get started</p>
          </div>
        ) : (
          <div className="main-content">
            ...
            {/* Bot Stats */}
            <section className="section">
              <h2 className="section-title">Bot Stats</h2>
              ...
              <div className="config-grid">
                ...
                <div className="full-width checkbox-container">
                  <input
                    ...
                    className="checkbox"
                  />
                  <span className="checkbox-label">Manual mode</span>
                </div>
              </div>
              {isPaid && (
                <div className="button-group">
                  ...
                  >
                    {liquidityStatus === 'active' ? 'Active' : 'Start'}
                  </button>
            ...
            <section className="section">
              ...
              <div className="config-grid">
                ...
                <div>
                  <label className="label">Volume (TON)</label>
                  <input
                    type="number"
                    name="dailyVolume"
              ...
              {isPaid && (
                <div className="button-group">
                  ...
                  >
                    {swapStatus === 'active' ? 'Active' : 'Start'}
                  </button>
                  {swapStatus === 'active' && (
                    <button
            ...
            <section className="section">
              ...
              {trades.length === 0 ? (
                <p className="no-tokens">No trades yet</p>
              ) : (
                    ...
                    <div key={trade.id} className="trade-item">
                      <div className="trade-info">
                        <p className="trade-type">
                          {trade.type === 'liquidity' ? 'Liquidity' : 'Swap'}: {trade.tokenA} → {trade.tokenB}
                        </p>
          ...
          <div className="modal-overlay">
            <div className="modal-content">
              ...
              <p className="modal-text">
                Fee: <span className="modal-fee">15 TON</span> for 30 days
              </p>
              {paymentStatus === 'success' && (
                <p className="modal-status-success">Bot activated!</p>
              )}
              {paymentStatus === 'failed' && (
                <p className="modal-status-failed">Payment failed</p>
              )}
