...
const Trade: React.FC = () => {
  ...
  const handleSwapClick = async () => {
    ...
    setIsLoading(true);
    setTimeout(() => {
      alert('Транзакция отправлена (заглушка)');
      setFromBalance(
        ...
        <div className="trade-wrapper">
          <div className="swap-card">
            <div className="card-header">
              <h2 className="card-title">Своп</h2>
            ...
            {showSettings && (
              <div className="settings-panel">
                <h3 className="settings-title">Настройки свопа</h3>
                <div>
                  <label className="settings-label">Допустимое проскальзывание</label>
            ...
            <div className="token-input-container">
              <div className="token-input-header">
                <span className="input-label">Вы отправляете</span>
                <span className="balance-info">Баланс: {fromBalance}</span>
              </div>
            ...
            <div className="token-input-container">
              <div className="token-input-header">
                <span className="input-label">Вы получаете</span>
                <span className="balance-info">Баланс: {toBalance}</span>
              </div>
              <div className="token-input-field">
                <input
                  type="number"
            ...
            <div className="swap-info-container">
              ...
              <div className="info-item">
                <span className="info-label">Проскальзывание:</span>
                <span>{slippage}%</span>
              </div>
              <div className="info-item">
