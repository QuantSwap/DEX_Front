  ...
  const navItems = [
    {
      ...
      links: [
        { to: '/dashboard/trader', label: 'ТРЕЙДЕР' },
        { to: '/dashboard/creator', label: 'СОЗДАТЕЛЬ' },
      ],
    },
    {
      title: 'Торговля',
      ...
      links: [
        ...
        { to: '/trade/orderbook', label: 'КНИГА ОРДЕРОВ' },
      ],
    },
    {
      title: 'Пулы',
    ...
    },
    {
      ...
      links: [
        { to: '/bots/mm', label: 'MM БОТ' },
        { to: '/bots/trade', label: 'ТОРГОВЫЙ БОТ' },
      ],
    },
    {
      title: 'Распределение',
      ...
      links: [
        ...
        { to: '/distribution/slot', label: 'SLOT МАШИНА' },
      ],
    },
   // Sidebar.tsx
{
  ...
  links: [
    { to: '/poso/mining', label: 'МАЙНЕРЫ' },
    { to: '/poso/my-mining', label: 'МОЙ МАЙНЕР' }
  ]
},
